...
inline bool VerifyAdapterBuffer(
  ...
  return verifier.template VerifyBuffer<onnxruntime::adapters::Adapter>(AdapterIdentifier());
}

template <bool B = false>
inline bool VerifySizePrefixedAdapterBuffer(
    ::flatbuffers::VerifierTemplate<B> &verifier) {
  return verifier.template VerifySizePrefixedBuffer<onnxruntime::adapters::Adapter>(AdapterIdentifier());
}
